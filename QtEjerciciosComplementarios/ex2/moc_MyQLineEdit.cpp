...
static const char qt_meta_stringdata_MyQLineEdit[] = {
    "MyQLineEdit\0\0str\0pintar(QString)\0b\0"
    "changeCheck(bool)\0actualitzar()\0"
};
...
void MyQLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->pintar((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->changeCheck((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->actualitzar(); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void MyQLineEdit::pintar(QString _t1)
{
...
// SIGNAL 1
void MyQLineEdit::changeCheck(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
