...
static const char qt_meta_stringdata_MyLabel[] = {
    "MyLabel\0\0g\0Groc(int)\0v\0Vermell(int)\0"
    "t\0TemperaturaLabel(int)\0g,v,temp\0"
    "Color(int,int,int)\0Suma()\0Resta()\0"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Groc((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->Vermell((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->TemperaturaLabel((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->Color((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
