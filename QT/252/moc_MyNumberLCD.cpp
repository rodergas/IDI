...
struct qt_meta_stringdata_MyNumberLCD_t {
    QByteArrayData data[4];
    char stringdata[32];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MyNumberLCD_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyNumberLCD_t qt_meta_stringdata_MyNumberLCD = {
    {
...
QT_MOC_LITERAL(3, 18, 13)
    ...
    "MyNumberLCD\0Zero\0\0ColorOnChange"
};
...
const QMetaObject MyNumberLCD::staticMetaObject = {
    { &QLCDNumber::staticMetaObject, qt_meta_stringdata_MyNumberLCD.data,
      qt_meta_data_MyNumberLCD,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyNumberLCD.stringdata))
