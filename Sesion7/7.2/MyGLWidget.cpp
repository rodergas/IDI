...
void MyGLWidget::initializeGL ()
{
  ...
  projectTransform ();
  viewTransform ();
  posF = glm::vec3(0, 1, -1);  // en SCA
  colF = glm::vec3(0.8, 0.8, 0.8);
  llumA = glm::vec3(0.2,0.2,0.2);
  Llum();
}
...
void MyGLWidget::Llum() {
    //Color Llum
    glUniform3f(colFocusLoc, colF[0], colF[1], colF[2]);
    //Posicio Llum
    posF = glm::normalize(glm::mat3(View*TG)*posF);
    //posF = glm::normalize(posF);
