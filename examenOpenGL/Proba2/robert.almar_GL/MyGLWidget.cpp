...
void MyGLWidget::createBuffers ()
{
  ...
  glm::vec3 amb(0.8,0.8,0);
  glm::vec3 diff(0.8,0.8,0);
  glm::vec3 spec(1.,1.,1.);
  float shin = 100;
...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::translate(glm::mat4(1.f), glm::vec3(0,0,-8 + moverEje));
...
{
  glm::mat4 TG;  // Matriu de transformació
  TG = glm::translate(glm::mat4(1.f), glm::vec3(0,3,-8 + moverEje));
...
{
  glm::mat4 TG;  // Matriu de transformació
  TG = glm::translate(glm::mat4(1.f), glm::vec3(0,3+2.5,-8 + moverEje));
  TG = glm::scale(TG, glm::vec3(escala3, escala3, escala3));
  TG = glm::translate(TG, -centreBasePatr);
  glUniformMatrix4fv (transLoc, 1, GL_FALSE, &TG[0][0]);
}
...
void MyGLWidget::projectTransform ()
{
  ...
  if (ra > 1) {
    glm::mat4 Proj = glm::perspective(FOV, ra, double(d-r), double(d + r)*4);
    glUniformMatrix4fv(projLoc, 1, GL_FALSE, &Proj[0][0]);
  }
  else {
...
void MyGLWidget::viewTransform ()
{
  ...
  View = glm::translate(glm::mat4(1.f), glm::vec3(0, -5.5/2, -20));
...
void MyGLWidget::calculaCapsaModel ()
{
  ...
  glm::vec3 a = glm::vec3(maxx - minx, 5.5, maxz - minz);

  r = (sqrt(a.x*a.x +  a.y*a.y + a.z*a.z))/2.0;
...
void MyGLWidget::keyPressEvent (QKeyEvent *e)
{
  ...
  case Qt::Key_X : {
      if(franjas){
       glUniform1i(franjaLoc,1);
      }else{
          glUniform1i(franjaLoc,0);
...
void MyGLWidget::llumMagenta()
{
glUniform3f(colFocusLoc, 1,0,1);
}

void MyGLWidget::llumInicial()
{
glUniform3f(colFocusLoc, 1,1,1);
}
