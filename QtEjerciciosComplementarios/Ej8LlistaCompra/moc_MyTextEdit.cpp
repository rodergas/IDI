...
static const char qt_meta_stringdata_MyTextEdit[] = {
    "MyTextEdit\0\0s\0AgafarString(QString)\0"
    "n\0AgafarNum(int)\0Afegir()\0"
};
...
void MyTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->AgafarString((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->AgafarNum((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->Afegir(); break;
        default: ;
        }
    }
}
